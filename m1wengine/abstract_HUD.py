...
class AbstractHud(pygame.sprite.Group, ABC):
    ...
    _level_hint_txt: pygame.sprite.Sprite
    ...
    def __init__(self):
        ...
        self._level_hint_txt: pygame.sprite.Sprite = pygame.sprite.Sprite()
    ...
    def start_prompt_timer(self) -> None:
        ...
        """
        raise NotImplementedError("This method must be implmented.")
